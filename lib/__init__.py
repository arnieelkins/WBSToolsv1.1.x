...
# -*- coding: utf-8 -*-
######
# In order for Dabo to 'see' classes in your lib directory, add an
...
#
# Now you can refer to these classes as: self.Application.lib.FirstClass and
# self.Application.lib.SecondClass
######
