# -*- coding: utf8 -*-
# Copyright (C) 2009-2013 The Board of Regents of the University of Wisconsin System 
#
    ...
    def startElement(self, name, attributes):
        ...
        if name in [u'paragraphlayout', u'paragraph', u'symbol', u'text']:
            ...
            for x in attributes.keys():
                ...
                # At some point, they changed the fontsize attribute to fontpointsize.  This needs to be caught!
                if x == u'fontsize':
                    # ... update the current font dictionary
                    self.fontAttributes[name][u'fontpointsize'] = attributes[x]
...
##                return 
            ...
            if cw == "ansicpg":
                ...
                if (num == 1252) and DEBUG:
                    ...
                    print "ansicpg is NOT 1252, US English or 10000, Mac Roman."
