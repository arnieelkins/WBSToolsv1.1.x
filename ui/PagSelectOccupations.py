...
class PagSelectOccupations(PagSelectBase):
...
if __name__ == "__main__":
    ...
    frm = TestForm(Caption="Test Of PagSelectOccupations", Testing=True)
    test = PagSelectOccupations(frm)
    test.createItems()
